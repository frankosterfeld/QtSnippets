 ...
 * DelayingProxyDevice: A QIODevice proxy ensuring the data to arrive in small chunks instead of . Meant to unit-test parsers and other code reading from I/O devices that
must be able to handle partial reads.
